...
X_datapaths = ['./preprocessed/prepared/nan/L2Y1.pkl','./preprocessed/prepared/nan/L2Y2.pkl','./prepared/nan/L2Y3.pkl','./KELS-educon/preprocessed/prepared/nan/L2Y4.pkl','./KELS-educon/preprocessed/prepared/nan/L2Y5.pkl','./KELS-educon/preprocessed/prepared/nan/L2Y6.pkl',]
label_datapath = './KELS-educon/preprocessed/prepared/nan/label.pkl'
...
model_E = ViT_LRP_nan_excluded.VisionTransformer(sample_datas,split_list,seq_len=6, num_classes=9, embed_dim=16*3, depth=8,num_heads=6, mlp_ratio=4., qkv_bias=False, mlp_head=False, drop_rate=0.2, attn_drop_rate=0.2)
